...
//////////////////////////////////////////////////////////////////////////////////////////////////
//MAKE BAR CHARTS WITH NO OF GAMES PER SYSTEM
//////////////////////////////////////////////////////////////////////////////////////////////////

//Pull in data and convert all numeric strings to integers
    //Nesting and rollup uses code adapted from https://stackoverflow.com/questions/17601105/how-do-i-convert-strings-from-csv-in-d3-js-and-be-able-to-use-them-as-a-dataset?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
    ...
    //Group objects by publisher and get total number of games in the top 100
        ...
        //Set up scales
        //Get X max and min
        var systemExtent = d3.extent(games_volume, function(d, i){
            return i;
        })
        console.log(systemExtent)
        //Get y max and min
        ...
        minSys = systemExtent[0];
        maxSys = systemExtent[1];
