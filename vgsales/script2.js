...
//Pull in data and convert all numeric strings to integers
    //Uses code adapted from Stackoverfow user Adam Pearce's reply to https://stackoverflow.com/questions/17601105/how-do-i-convert-strings-from-csv-in-d3-js-and-be-able-to-use-them-as-a-dataset?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
    ...
    //Group objects by publisher and get total number of games in the top 100
        //uses code adapted from http://learnjsdata.com/group_data.html (nest) and Stackoverflow user Nisfan's reply to https://stackoverflow.com/questions/30480981/d3-js-sorting-by-rollup-field (sort)
        var games_volume = d3.nest()
            ...
            .entries(data)
            .sort(function(a,b){
                    return d3.descending(a.value.games, b.value.games);
                    })
