            ...
            .append("rect")
                ...
                .attr("height", function (d){
                  if (filter == "All") {
                    ...
                    return yScale(d.EU_Sales);
                  }
                  else if (filter == "Other"){
                    return yScale(d.Other_Sales);
                  }
                })
                .attr("x", function (d,i){
                ...
                .attr("y", function (d, i){
                  ...
                  if (filter == "Japan"){
                    return chartHeight + margin - yScale(d.JP_Sales);
                  }
                  if (filter == "NA"){
                    return chartHeight + margin - yScale(d.NA_Sales);
                  }
                  if (filter == "EU"){
                    return chartHeight + margin - yScale(d.EU_Sales);
                  }
                  if (filter == "Other"){
                    return chartHeight + margin - yScale(d.Other_Sales);
                  }
                })
